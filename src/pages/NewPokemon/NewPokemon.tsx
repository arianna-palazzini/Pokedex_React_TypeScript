    ...
    <div id="aggiungi-pokemon">
      <form>
        ...
        <input
          id="name"
          type="text"
          value={newPokemon.name as string}
        ...
        <input
          id="weight"
          type="number"
          value={newPokemon.weight as number}
          onChange={handleChange}
        />
        <label>Altezza:</label>
        <input
          id="height"
          type="number"
          value={newPokemon.height as number}
          onChange={handleChange}
        />
        ...
        <select
          id="family"
          value={newPokemon.family as string}
          onChange={handleChange}
        >
        ...
        <select
          id="ability"
          value={newPokemon.ability as string}
          onChange={handleChange}
        >
          <option>Seleziona un'abilità</option>
          {families
            .find((el) => el.nome === newPokemon.family)
            ?.abilities.map((el) => (
        ...
        />
        <button type="button" onClick={salvaPokemon}>
          Salva
        </button>
      </form>
    </div>
