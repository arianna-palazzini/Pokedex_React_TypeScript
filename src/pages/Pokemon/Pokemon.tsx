...
function Pokemon(){
    ...
    const pokemonSelezionato: PokemonSelected | null = useSelector((state: RootState) => state.general.pokemonSelezionato)
    ...
    return(
        ...
        <>
            ...
            <div id='dettaglio-pokemon'>
                ...
                <div>
                    <img src={pokemonSelezionato?.sprites.front_default} />
                    <img src={pokemonSelezionato?.sprites.back_default} />
                </div>
                <div>
